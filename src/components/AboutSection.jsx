...
const TAB_DATA = [
  {
    ...
    content: (
      <ul className="list-disc pl-2 flex flex-col gap-2">
        ...
        <li>
          Next Js <progress value={95} max={100} />
        </li>
        <li>
        ...
        <li>
          Node.js <progress value={90} max={100} />
        </li>
        <li>
          PostgreSQL <progress value={85} max={100} />
        </li>
        <li>
          MongoDB <progress value={95} max={100} />
        </li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Bachelor of Science in Computer Science and Engineering - American International University of Bangladesh</li>
      </ul>
    ),
  },
  {
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            ...
            working with JavaScript, React js, Next js, Tailwind CSS, Redux,
            Node.js, Express, PostgreSQL, Sequelize, HTML, CSS, and GitHub. I am
